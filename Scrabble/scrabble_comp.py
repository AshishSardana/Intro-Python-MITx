...
def compChooseWord(hand, wordList, n):
    ...
    def validity(word, hand):
        hand1=hand.copy()
        for i in word:
            if not hand1.get(i,0)==0:
                hand1[i]-=1
            else:
                return False
        return True
    ...
    for tempword in wordList:     
        if validity(tempword, hand) == True:
            tempscore=getWordScore(tempword, n)
...
def compPlayHand(hand, wordList, n):
    ...
    while not calculateHandlen(hand) == 0:
        ...
        if not word==None:
            ...
            total+=curr
            print("'" + word + "'" + " earned " + str(curr) + " points. Total: " + str(total) + " points")
            print
...
def playGame(wordList):
    ...
    while not choice1 == 'e':
        ...
        if choice1 == 'e':
            break
        elif not (choice1 == 'n' or choice1 == 'r'):
            print "Invalid command\n"
        elif choice1=='r' and hand=={}:
